                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Defect Reporting') }}</h3>
                            </div>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('pic') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="pic" id="input-pic"
                                           ...
                                           value="{{ old('pic') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('datetime_issue') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="input-date" name="datetime_issue"
                                               ...
                                               placeholder="{{ __('Issue date') }}" value="{{ old('datetime_issue') }}"
                                               required type="text">
                                ...
                                <div class="form-group{{ $errors->has('defect_desc') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="defect_desc" id="input-defect-desc"
                                           ...
                                           value="{{ old('defect_desc') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('remark') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="remark" id="input-remark"
                                           ...
                                           placeholder="{{ __('Please enter remark') }}" value="{{ old('remark') }}"
                                           required autofocus>
                                ...
                                <div class="form-group{{ ($errors->has('lat') || $errors->has('lng')) && ' has-danger' }}">
                                    ...
                                    <input type="hidden" name="latitude" id="lat" class="form-control form-control-alternative">
                                    <input type="hidden" name="longitude" id="lng" class="form-control form-control-alternative">
                ...
                function initMap() {
                    ...
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(function (position) {
                            ...
                            infoWindow.setContent('Drag marker to point at your desire location');
                            infoWindow.open(gm, marker);
                            //following line re-uses your custom marker
                            marker.setPosition(pos);
                            gm.setCenter(pos);
                        }, function () {
                            handleLocationError(true, infoWindow, gm.getCenter());
                        });
                    } else {
                        // Browser doesn't support Geolocation
                        handleLocationError(false, infoWindow, gm.getCenter());
                    }
